...
BToKee = cms.EDProducer(
    ...
    isotrkDCALooseCut = cms.double(1.0),
...
BToKmumu = cms.EDProducer(
    ...
    isotrkDCALooseCut = BToKee.isotrkDCALooseCut,
...
BToKeeTable = cms.EDProducer(
    ...
    variables=cms.PSet(
        ...
        l1_iso03_dca_loose = ufloat('l1_iso03_dca_loose'),
        l1_iso04_dca_loose = ufloat('l1_iso04_dca_loose'),
        l2_iso03_dca_loose = ufloat('l2_iso03_dca_loose'),
        l2_iso04_dca_loose = ufloat('l2_iso04_dca_loose'),
        k_iso03_dca_loose  = ufloat('k_iso03_dca_loose'),
        k_iso04_dca_loose  = ufloat('k_iso04_dca_loose'),
        b_iso03_dca_loose  = ufloat('b_iso03_dca_loose'),
        b_iso04_dca_loose  = ufloat('b_iso04_dca_loose'),
